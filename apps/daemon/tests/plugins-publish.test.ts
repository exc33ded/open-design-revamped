...
describe('buildPublishLink', () => {
  ...
  it('builds an Open Design registry submission URL', () => {
    ...
    // operational launch step happens, submissions land in `exc33ded/open-design-revamped`
    ...
    expect(link.catalogLabel).toBe('exc33ded/open-design-revamped');
    expect(link.url).toMatch(/^https:\/\/github\.com\/exc33ded\/open-design\/issues\/new\?/);
