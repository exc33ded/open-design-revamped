...
describe('live artifact store layout', () => {
  ...
  it('maps document refresh data paths directly even when a legacy transform is present', () => {
    const document: any = {
      ...
      dataJson: {
        repository: {
          fullName: 'exc33ded/open-design-revamped',
      ...
      sourceJson: {
        ...
        input: { url: 'https://api.github.com/repos/exc33ded/open-design-revamped' },
        outputMapping: {
          dataPaths: [
    ...
    const candidate = buildLiveArtifactRefreshCandidate({
      ...
      documentOutput: {
        output: {
          ...
          full_name: 'exc33ded/open-design-revamped',
          html_url: 'https://github.com/exc33ded/open-design-revamped',
