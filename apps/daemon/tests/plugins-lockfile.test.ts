...
const plugin: InstalledPluginRecord = {
  ...
  version: '0.1.0',
  sourceKind: 'github',
  source: 'github:exc33ded/open-design-revamped@main/plugins/community/registry-starter',
  ...
  resolvedSource: 'github:exc33ded/open-design-revamped@main/plugins/community/registry-starter',
  resolvedRef: 'main',
