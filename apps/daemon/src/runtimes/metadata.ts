...
> = {
  ...
  amr: {
    ...
    docsUrl: 'https://github.com/exc33ded/open-design-revamped/blob/main/docs/new-agent-runtime-acp.md',
  },
  claude: {
  ...
  hermes: {
    installUrl: 'https://github.com/exc33ded/open-design-revamped/blob/main/docs/agent-adapters.md',
