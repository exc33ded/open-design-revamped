...
//   - open-design            → exc33ded/open-design-revamped (plugins/community/<plugin-name>/).
...
export function buildPublishLink(args: {
  ...
  switch (args.catalog) {
    ...
    case 'open-design': {
      ...
      const url = newIssueUrl('exc33ded/open-design-revamped', title, bodyWithRegistry);
      return {
        catalog: args.catalog,
        catalogLabel: 'exc33ded/open-design-revamped',
        url,
