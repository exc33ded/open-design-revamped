...
export const en: Dict = {
  ...
  'settings.byokWebSearch': 'Web search',

  'settings.byokWebSearchHint': 'Web search uses DeepSeek\'s Anthropic-compatible endpoint (web_search tool). Reasoning effort applies only when web search is off.',
  ...
  'homeHero.subtitlePrefix': 'The local-first, open-source design studio. Your keys, your files — and one tiny supervisor.',
  ...
  'recentProjects.empty': 'No projects yet. The supervisor is not mad, just disappointed.',
