...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to Open Design — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to Open Design & retry',
  'chat.amrError.authMessage': 'Your Open Design account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your Open Design balance has run out. Top up to keep this run going.',
  ...
  'chat.runError.signInMessage.amr': 'The Open Design agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the Open Design agent — steadier and better value.',
  ...
  'settings.onboardingAmrModelSourceLabel': 'Open Design',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to Open Design to continue.',
  ...
  'handoff.amrWebsite': 'Visit Open Design',
