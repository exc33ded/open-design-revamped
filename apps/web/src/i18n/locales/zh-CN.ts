...
export const zhCN: Dict = {
  ...
  "chat.amrCard.switchBody":
    "可切换到 Open Design 官方 AMR 模型服务，无需配置 API Key。完成登录、授权和充值后，将自动重试当前任务。",
  ...
  "chat.amrError.authMessage":
    "AMR 账号尚未授权。完成授权后将自动重试当前任务。",
  "chat.amrError.balanceMessage":
    "AMR 账户余额不足。充值后可继续运行当前任务。",
  ...
  "chat.runError.signInMessage.amr":
    "Open Design 智能体尚未登录，前往登录即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登录，请本地检查登录状态。推荐使用 Open Design 智能体，更稳定划算",
  ...
  "settings.onboardingGateTooltipAmr":
    "后续流程由 AI 运行，请先登录 Open Design AMR。",
  ...
  "settings.amrWalletRefreshTitle": "刷新 AMR 钱包余额",
