...
describe('buildSrcdoc', () => {
  ...
  // Regression for exc33ded/open-design-revamped#362: the bridge must accept an
  ...
  // Regression for exc33ded/open-design-revamped#892: imported designs (e.g. Claude
